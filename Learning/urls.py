...
from home.views import index,course_detail,courses,learning,LearningDetail,news
...
urlpatterns = [
    ...
    url(r'^learning_details/(?P<pk>\d+)/$', LearningDetail.as_view(), name='learning_detail'),
...
# Admin Site Config
admin.sites.AdminSite.site_header = 'Learnx Admin'
admin.sites.AdminSite.site_title = 'Learnx Admin'
admin.sites.AdminSite.index_title = 'Learnx Admin'
